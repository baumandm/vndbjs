require('chai').should();
const vndb = require('../src/Vndb.js').init({
  clientName: 'VNDBtest',
  pool: true
});
const vndbUnpooled = require('../src/Vndb.js').init({
  clientName: 'VNDBtest2',
  pool: false
});
...
describe('vndb.stats', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with results', function() {
    return vndbUnpooled.stats().then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'dbstats');
      response.should.have.property('body');
      response.should.have.deep.property('body.tags');
...
describe('vndb.query', function() {
  it('Should succeed and return JSON with results', function() {
    ...
    it('[Unpooled] Should succeed and return JSON with results', function() {
    return vndbUnpooled.query('dbstats').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'dbstats');
      response.should.have.property('body');
      response.should.have.deep.property('body.tags');
  ...
  it('[Unpooled] Should fail and return JSON with an error.', function() {
    return vndbUnpooled.query('dbstat').then(function() {
...
describe('vndb.query (VN)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with VN results', function() {
    return vndbUnpooled.query('get vn basic,anime (id = 17)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', false);
  ...
  it('[Unpooled] Should fail and return JSON with an error.', function() {
    return vndbUnpooled.query('get vn basic,anime d = 17)').then(function() {
...
describe('vndb.query (Release)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with Release results', function() {
    return vndbUnpooled.query('get release basic,details (id = 39520)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', false);
...
describe('vndb.query (Producer)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with Producer results', function() {
    return vndbUnpooled.query('get producer basic,details (id = 4)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', false);
...
describe('vndb.query (Character)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with Character results', function() {
    return vndbUnpooled.query('get character basic,details (id = 108)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', false);
...
describe('vndb.query (User)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with User results', function() {
    return vndbUnpooled.query('get user basic (username ~ "Darkarcher117")').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', false);
...
describe('vndb.query (Votelist)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with Votelist results', function() {
    return vndbUnpooled.query('get votelist basic (uid = 111679)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', true);
...
describe('vndb.query (VNlist)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with VNlist results', function() {
    return vndbUnpooled.query('get vnlist basic (uid = 111679)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', true);
...
describe('vndb.query (Wishlist)', function() {
  ...
  it('[Unpooled] Should succeed and return JSON with Wishlist results', function() {
    return vndbUnpooled.query('get wishlist basic (uid = 111679)').then(function(response) {
      response.should.be.a('object');
      response.should.have.property('head', 'results');
      response.should.have.property('body');
      response.should.have.deep.property('body.more', true);
